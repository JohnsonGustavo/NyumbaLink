                  ...
                  <div className="space-y-3">
                    ...
                    {property.profiles?.phone && (
                      <Button 
                        ...
                        onClick={() => {
                          const phoneNumber = property.profiles?.phone?.replace(/[^0-9]/g, '');
                          const message = encodeURIComponent(`Hujambo, ninapenda kujua zaidi kuhusu nyumba hii: ${property.title}`);
                          window.open(`https://wa.me/255${phoneNumber?.substring(1)}?text=${message}`, '_blank');
                        }}
                      >
